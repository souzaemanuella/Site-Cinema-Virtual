...
}; // <-- CORREÇÃO: Faltava fechar o objeto.

const cores = {
  "12": "rgba(238, 207, 69, 1)", // <-- CORREÇÃO: Mudei a cor de volta para o amarelo original
  "14": "orange",
  "16": "red",
  "18": "black",
  "L": "green"
...
document.querySelectorAll("#generos .opcoes_genero").forEach(op => {
    op.addEventListener("click", () => {
        ...
        // 1. Pega o texto do gênero que foi clicado (ex: "Ação")
        const generoTexto = op.textContent;
        // 2. Usa a função para formatar o texto (ex: "acao")
        const genero = removerAcento(generoTexto);
        // 3. Chama a função para mostrar os filmes desse gênero
